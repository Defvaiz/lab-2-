...
namespace lab2
{
     ...
     class Program
    {
        ...
        {
            Person person = new Person("Максим", "Паньков", new DateTime(2003,5,20));

            Exam[] examen = new Exam[3];
            examen[0] = new Exam("История", 4, new DateTime(2019, 2, 3));
            examen[1] = new Exam("Математика", 4, new DateTime(2020, 4, 8));
            examen[2] = new Exam("Физика", 4, new DateTime(2021, 9, 5));
